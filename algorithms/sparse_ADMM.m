% -------------------------------------------------------------------------
% x_hat = sparse_ADMM(Phi, y, lambda)
%
% Convex optimization using ADMM for sparse vector recovery
% -------------------------------------------------------------------------
% Phi: M×N array
% y:   M×1 array
% x_hat: N×1 vector
%--------------------------------------------------------------------------
function x = sparse_ADMM(Phi, y, lambda, varargin)
...
for iter = 1:max_iters
    ...
    z = softThresholding(x + 1/rho * nu, lambda/rho);
    nu = nu + rho * (x - z);
...
function y = softThresholding(x, thresh)
